...
% GuASPSO algorithm                                                                  
function [z_iter,z_final,pos_final] = GuASPSO(nrun,np,nx,somit,maxit,varmax,varmin,velmax,velmin,k_max,k_min,fobj,w_mode,lr_max,cluster_max,cluster_min)
it=1;
