...
close all
tic
run=3; % Maximum number of the algorithm runnings conducted
...
for nrun=1:run
    [z_iter,z_final,pos_final]=GuASPSO(nrun,np,nx,somit,maxit,varmax,varmin,velmax,velmin,k_max,k_min,fobj,w_mode,lr_max,cluster_max,cluster_min);
